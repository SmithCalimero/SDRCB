    ...
    public class DataBaseHandler {
        ...
        public synchronized boolean insertShows(ClientData clientData, ObjectOutputStream oos, ObjectInputStream ois) {
            //LOG.log("Unable to insert show(s) from user [" + clientData.getUsername() + "]");
            return false;
        }
